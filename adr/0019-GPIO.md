...
Changelog:
 - 2026-04-02 Removed Supervised from the list of installation methods
...
- The use of GPIO via containers (including our Home Assistant OS &
  Container installation methods) is often unstable or complicated.
